...
<div class="logisco-body-outer-wrapper ">
    <class="logisco-body-wrapper clearfix  logisco-with-transparent-header logisco-with-frame">
            ...
            <div class=gdlr-core-page-builder-body>
                <div class="gdlr-core-pbf-wrapper " style="padding: 350px 0px 160px 0px;" id=gdlr-core-wrapper-1>
                    <div class=gdlr-core-pbf-background-wrap>
                        <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url(' {{ asset('static/homepage/upload/bg-3.jpg') }}')  ;background-size: cover ;background-position: center ;" data-parallax-speed=0.3></div>
                    </div>
                                        ...
                                        <div class=gdlr-core-pbf-element>
                                            <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                                <div class=gdlr-core-text-box-item-content style="font-size: 16px ;text-transform: none ;">
                                                    <p><a href="contact.html#">+1-2345-2345</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 50px 20px 0px 20px;">
                                    <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js " data-gdlr-animation=fadeInDown data-gdlr-animation-duration=600ms data-gdlr-animation-offset=0.8>
                                        ...
                                        <div class=gdlr-core-pbf-element>
                                            <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                                <div class=gdlr-core-text-box-item-content style="font-size: 16px ;">
                                                    <p><a href="contact.html#">Contact@goodlayers.com</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 50px 20px 0px 20px;">
                                    <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js " data-gdlr-animation=fadeInUp data-gdlr-animation-duration=600ms data-gdlr-animation-offset=0.8>
                                        ...
                                        <div class=gdlr-core-pbf-element>
                                            <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                                <div class=gdlr-core-text-box-item-content style="font-size: 16px ;">
                                                    <p><a href="contact.html#">View On Google Map</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                {{-- <div class="gdlr-core-pbf-wrapper " style="padding: 80px 0px 50px 0px;">
                    ...
                    <div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
                        <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                            <div class=gdlr-core-pbf-element>
                                <div class="gdlr-core-social-network-item gdlr-core-item-pdb  gdlr-core-center-align gdlr-core-item-pdlr"><a href=mailto:# target=_blank class=gdlr-core-social-network-icon title=email style="font-size: 20px ;color: #1e1e1e ;"><i class="fa fa-envelope" ></i></a><a href="contact.html#" target=_blank class=gdlr-core-social-network-icon title=facebook style="font-size: 20px ;color: #1e1e1e ;margin-left: 40px ;"><i class="fa fa-facebook" ></i></a><a href="contact.html#" target=_blank class=gdlr-core-social-network-icon title=google-plus style="font-size: 20px ;color: #1e1e1e ;margin-left: 40px ;"><i class="fa fa-google-plus" ></i></a><a href="contact.html#" target=_blank class=gdlr-core-social-network-icon title=skype style="font-size: 20px ;color: #1e1e1e ;margin-left: 40px ;"><i class="fa fa-skype" ></i></a><a href="contact.html#" target=_blank class=gdlr-core-social-network-icon title=twitter style="font-size: 20px ;color: #1e1e1e ;margin-left: 40px ;"><i class="fa fa-twitter" ></i></a></div>
                            </div>
                        </div>
                    </div>
                </div> --}}
