...
class ExternalAza extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'bank_routing_number' => 'required|digit:9',
            'bank_nickname' => 'sometimes|string|max:100',
        ];
    }
       /**
     ...
     public function messages()
     {
         return [
            //  'bank_account_type.required' => 'Kindly select preferred bank account type!',
             ...
             'bank_account_number.required' => 'Kindly provide beneficiary bank account number!',
             'bank_routing_number.required' => 'Kindly provide beneficiary bank routing number!',
